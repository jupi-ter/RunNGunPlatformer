...
public static class SpriteNames
{
    ...
    public static SpriteDefinition Bullet = new (path: "bullet", name: "Bullet", frames: 2);
    public static SpriteDefinition Machinegun = new (path: "machinegun", name: "Machinegun");
}
